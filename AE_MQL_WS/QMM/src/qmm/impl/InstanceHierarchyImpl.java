...
public class InstanceHierarchyImpl extends CAEXObjectImpl implements InstanceHierarchy {
	...
	public EList<InternalElement_Containment_OrGroup> getInternalElement() {
		if (internalElement == null) {
			internalElement = new EObjectContainmentEList<InternalElement_Containment_OrGroup>(InternalElement_Containment_OrGroup.class, this, QmmPackage.INSTANCE_HIERARCHY__INTERNAL_ELEMENT);
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseOperationID) {
				case QmmPackage.NAMED_ELEMENT___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.INSTANCE_HIERARCHY___VALIDATE__DIAGNOSTICCHAIN_MAP;
