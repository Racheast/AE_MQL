...
public class SystemUnitClassLibImpl extends CAEXObjectImpl implements SystemUnitClassLib {
	...
	public EList<SystemUnitClass_Containment_OrGroup> getSystemUnitClass() {
		if (systemUnitClass == null) {
			systemUnitClass = new EObjectContainmentEList<SystemUnitClass_Containment_OrGroup>(SystemUnitClass_Containment_OrGroup.class, this, QmmPackage.SYSTEM_UNIT_CLASS_LIB__SYSTEM_UNIT_CLASS);
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseOperationID) {
				case QmmPackage.NAMED_ELEMENT___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.SYSTEM_UNIT_CLASS_LIB___VALIDATE__DIAGNOSTICCHAIN_MAP;
