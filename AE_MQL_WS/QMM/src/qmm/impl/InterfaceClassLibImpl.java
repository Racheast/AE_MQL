...
public class InterfaceClassLibImpl extends CAEXObjectImpl implements InterfaceClassLib {
	...
	public EList<InterfaceClass_Containment_OrGroup> getInterfaceClass() {
		if (interfaceClass == null) {
			interfaceClass = new EObjectContainmentEList<InterfaceClass_Containment_OrGroup>(InterfaceClass_Containment_OrGroup.class, this, QmmPackage.INTERFACE_CLASS_LIB__INTERFACE_CLASS);
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseOperationID) {
				case QmmPackage.NAMED_ELEMENT___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.INTERFACE_CLASS_LIB___VALIDATE__DIAGNOSTICCHAIN_MAP;
