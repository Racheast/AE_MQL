	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseOperationID) {
				case QmmPackage.NAMED_ELEMENT___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.ATTRIBUTE_DATA_TYPE_ATTRIBUTE_ECLASS___VALIDATE__DIAGNOSTICCHAIN_MAP;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == Calculateable.class) {
			switch (baseOperationID) {
				default: return -1;
			}
		}
		if (baseClass == AttributeDataType_Calculateable.class) {
			switch (baseOperationID) {
				default: return -1;
			}
		}
		if (baseClass == CalculateableElement.class) {
			switch (baseOperationID) {
				default: return -1;
			}
		}
		if (baseClass == AttributeDataType_CalculateableElement.class) {
			switch (baseOperationID) {
				default: return -1;
			}
		}
