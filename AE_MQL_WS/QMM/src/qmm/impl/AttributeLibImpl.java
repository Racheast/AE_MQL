...
public class AttributeLibImpl extends CAEXObjectImpl implements AttributeLib {
	 ...
	 * @ordered
	 */
	protected EList<Attribute_Containment_OrGroup> attributeType;
	 ...
	 * @generated
	 */
	public EList<Attribute_Containment_OrGroup> getAttributeType() {
		if (attributeType == null) {
			attributeType = new EObjectContainmentEList<Attribute_Containment_OrGroup>(Attribute_Containment_OrGroup.class, this, QmmPackage.ATTRIBUTE_LIB__ATTRIBUTE_TYPE);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QmmPackage.ATTRIBUTE_LIB__ATTRIBUTE_TYPE:
				...
				getAttributeType().addAll((Collection<? extends Attribute_Containment_OrGroup>)newValue);
				return;
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseOperationID) {
				case QmmPackage.NAMED_ELEMENT___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.ATTRIBUTE_LIB___VALIDATE__DIAGNOSTICCHAIN_MAP;
