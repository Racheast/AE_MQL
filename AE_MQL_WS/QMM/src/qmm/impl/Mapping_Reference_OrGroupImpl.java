...
import qmm.Mapping;
import qmm.Mapping_Reference_OrGroup;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Mapping Reference Or Group</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link qmm.impl.Mapping_Reference_OrGroupImpl#getReference <em>Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Mapping_Reference_OrGroupImpl extends Reference_OrGroupImpl implements Mapping_Reference_OrGroup {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Mapping> reference;
	 ...
	 * @generated
	 */
	protected Mapping_Reference_OrGroupImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return QmmPackage.eINSTANCE.getMapping_Reference_OrGroup();
	}
	 ...
	 * @generated
	 */
	public EList<Mapping> getReference() {
		if (reference == null) {
			reference = new EObjectResolvingEList<Mapping>(Mapping.class, this, QmmPackage.MAPPING_REFERENCE_OR_GROUP__REFERENCE);
		}
		return reference;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QmmPackage.MAPPING_REFERENCE_OR_GROUP__REFERENCE:
				return getReference();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QmmPackage.MAPPING_REFERENCE_OR_GROUP__REFERENCE:
				getReference().clear();
				getReference().addAll((Collection<? extends Mapping>)newValue);
				return;
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseOperationID) {
				case QmmPackage.NAMED_ELEMENT___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.MAPPING_REFERENCE_OR_GROUP___VALIDATE__DIAGNOSTICCHAIN_MAP;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == OrGroup.class) {
			switch (baseOperationID) {
				case QmmPackage.OR_GROUP___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.MAPPING_REFERENCE_OR_GROUP___VALIDATE__DIAGNOSTICCHAIN_MAP;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QmmPackage.MAPPING_REFERENCE_OR_GROUP___VALIDATE__DIAGNOSTICCHAIN_MAP:
				return validate((DiagnosticChain)arguments.get(0), (Map)arguments.get(1));
		}
		return super.eInvoke(operationID, arguments);
	}

} //Mapping_Reference_OrGroupImpl
