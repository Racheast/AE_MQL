...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sum Aggregation Operator Double</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link qmm.impl.Sum_AggregationOperator_DoubleImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link qmm.impl.Sum_AggregationOperator_DoubleImpl#getCalculateable <em>Calculateable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Sum_AggregationOperator_DoubleImpl extends CalculatingAggregationOperatorImpl implements Sum_AggregationOperator_Double {
	/**
	 ...
	 * @generated
	 */
	protected Sum_AggregationOperator_DoubleImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return QmmPackage.eINSTANCE.getSum_AggregationOperator_Double();
	}
	...
	public NotificationChain basicSetOperator(Double_FunctionalOperator newOperator, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE__OPERATOR, oldOperator, newOperator);
	...
	public void setOperator(Double_FunctionalOperator newOperator) {
		if (newOperator != operator) {
			...
			if (operator != null)
				msgs = ((InternalEObject)operator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE__OPERATOR, null, msgs);
			if (newOperator != null)
				msgs = ((InternalEObject)newOperator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE__OPERATOR, null, msgs);
			msgs = basicSetOperator(newOperator, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE__OPERATOR, newOperator, newOperator));
	}
	...
	public NotificationChain basicSetCalculateable(Double_CalculateableParameter newCalculateable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE__CALCULATEABLE, oldCalculateable, newCalculateable);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCalculateable(Double_CalculateableParameter newCalculateable) {
		if (newCalculateable != calculateable) {
			...
			if (calculateable != null)
				msgs = ((InternalEObject)calculateable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE__CALCULATEABLE, null, msgs);
			if (newCalculateable != null)
				msgs = ((InternalEObject)newCalculateable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE__CALCULATEABLE, null, msgs);
			msgs = basicSetCalculateable(newCalculateable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE__CALCULATEABLE, newCalculateable, newCalculateable));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE__OPERATOR:
				return basicSetOperator(null, msgs);
			case QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE__CALCULATEABLE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Double_FunctionalType.class) {
			switch (derivedFeatureID) {
				case QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE__OPERATOR: return QmmPackage.DOUBLE_FUNCTIONAL_TYPE__OPERATOR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Double_FunctionalType.class) {
			switch (baseFeatureID) {
				case QmmPackage.DOUBLE_FUNCTIONAL_TYPE__OPERATOR: return QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE__OPERATOR;
				default: return -1;
			}
		}
		if (baseClass == Double_Argument.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE___GET_LITERAL:
				return getLiteral();
			case QmmPackage.SUM_AGGREGATION_OPERATOR_DOUBLE___GET_ALL_PARAMETERS:
				return getAllParameters();
		}
		return super.eInvoke(operationID, arguments);
	}

} //Sum_AggregationOperator_DoubleImpl
