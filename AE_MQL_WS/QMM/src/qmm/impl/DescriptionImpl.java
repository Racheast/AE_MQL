...
public class DescriptionImpl extends RootClassImpl implements Description {
	 ...
	 * @ordered
	 */
	protected EList<Description_value_AttrEClass> value_AttrEClass;
	 ...
	 * @generated
	 */
	public EList<Description_value_AttrEClass> getValue_AttrEClass() {
		if (value_AttrEClass == null) {
			value_AttrEClass = new EObjectContainmentEList<Description_value_AttrEClass>(Description_value_AttrEClass.class, this, QmmPackage.DESCRIPTION__VALUE_ATTR_ECLASS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QmmPackage.DESCRIPTION__VALUE_ATTR_ECLASS:
				...
				getValue_AttrEClass().addAll((Collection<? extends Description_value_AttrEClass>)newValue);
				return;
			case QmmPackage.DESCRIPTION__CHANGE_MODE_ATTR_ECLASS:
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseOperationID) {
				case QmmPackage.NAMED_ELEMENT___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.DESCRIPTION___VALIDATE__DIAGNOSTICCHAIN_MAP;
