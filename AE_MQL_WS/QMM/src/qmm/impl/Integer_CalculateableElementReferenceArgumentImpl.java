...
import qmm.Integer_CalculateableElement;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Integer Calculateable Element Reference Argument</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link qmm.impl.Integer_CalculateableElementReferenceArgumentImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link qmm.impl.Integer_CalculateableElementReferenceArgumentImpl#getReference <em>Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Integer_CalculateableElementReferenceArgumentImpl extends CalculateableElement_ReferenceArgumentImpl implements Integer_CalculateableElementReferenceArgument {
	/**
	 ...
	 * @ordered
	 */
	protected Integer_CalculateableElement reference;
	 ...
	 * @generated
	 */
	protected Integer_CalculateableElementReferenceArgumentImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return QmmPackage.eINSTANCE.getInteger_CalculateableElementReferenceArgument();
	}
	...
	public NotificationChain basicSetOperator(Integer_FunctionalOperator newOperator, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__OPERATOR, oldOperator, newOperator);
	...
	public void setOperator(Integer_FunctionalOperator newOperator) {
		if (newOperator != operator) {
			...
			if (operator != null)
				msgs = ((InternalEObject)operator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__OPERATOR, null, msgs);
			if (newOperator != null)
				msgs = ((InternalEObject)newOperator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__OPERATOR, null, msgs);
			msgs = basicSetOperator(newOperator, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__OPERATOR, newOperator, newOperator));
	}
	 ...
	 * @generated
	 */
	public Integer_CalculateableElement getReference() {
		if (reference != null && reference.eIsProxy()) {
			InternalEObject oldReference = (InternalEObject)reference;
			reference = (Integer_CalculateableElement)eResolveProxy(oldReference);
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__REFERENCE, oldReference, reference));
			}
		}
		return reference;
	}
	 ...
	 * @generated
	 */
	public Integer_CalculateableElement basicGetReference() {
		return reference;
	}
	 ...
	 * @generated
	 */
	public void setReference(Integer_CalculateableElement newReference) {
		Integer_CalculateableElement oldReference = reference;
		reference = newReference;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__REFERENCE, oldReference, reference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__OPERATOR:
				return getOperator();
			case QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__REFERENCE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__OPERATOR:
				...
				return;
			case QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__REFERENCE:
				setReference((Integer_CalculateableElement)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__OPERATOR:
				...
				return;
			case QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__REFERENCE:
				setReference((Integer_CalculateableElement)null);
				return;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Integer_FunctionalType.class) {
			switch (derivedFeatureID) {
				case QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__OPERATOR: return QmmPackage.INTEGER_FUNCTIONAL_TYPE__OPERATOR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Integer_FunctionalType.class) {
			switch (baseFeatureID) {
				case QmmPackage.INTEGER_FUNCTIONAL_TYPE__OPERATOR: return QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT__OPERATOR;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QmmPackage.INTEGER_CALCULATEABLE_ELEMENT_REFERENCE_ARGUMENT___VALIDATE__DIAGNOSTICCHAIN_MAP:
				return validate((DiagnosticChain)arguments.get(0), (Map)arguments.get(1));
		}
		return super.eInvoke(operationID, arguments);
	}

} //Integer_CalculateableElementReferenceArgumentImpl
