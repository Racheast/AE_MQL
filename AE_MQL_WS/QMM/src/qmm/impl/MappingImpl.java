...
public class MappingImpl extends CAEXBasicObjectImpl implements Mapping {
	 ...
	 * @ordered
	 */
	protected EList<AttributeNameMapping_Containment_OrGroup> attributeNameMapping;
	 ...
	 * @ordered
	 */
	protected EList<InterfaceIDMapping_Containment_OrGroup> interfaceIDMapping;
	 ...
	 * @generated
	 */
	public EList<AttributeNameMapping_Containment_OrGroup> getAttributeNameMapping() {
		if (attributeNameMapping == null) {
			attributeNameMapping = new EObjectContainmentEList<AttributeNameMapping_Containment_OrGroup>(AttributeNameMapping_Containment_OrGroup.class, this, QmmPackage.MAPPING__ATTRIBUTE_NAME_MAPPING);
		}
	 ...
	 * @generated
	 */
	public EList<InterfaceIDMapping_Containment_OrGroup> getInterfaceIDMapping() {
		if (interfaceIDMapping == null) {
			interfaceIDMapping = new EObjectContainmentEList<InterfaceIDMapping_Containment_OrGroup>(InterfaceIDMapping_Containment_OrGroup.class, this, QmmPackage.MAPPING__INTERFACE_ID_MAPPING);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QmmPackage.MAPPING__ATTRIBUTE_NAME_MAPPING:
				...
				getAttributeNameMapping().addAll((Collection<? extends AttributeNameMapping_Containment_OrGroup>)newValue);
				return;
			case QmmPackage.MAPPING__INTERFACE_ID_MAPPING:
				getInterfaceIDMapping().clear();
				getInterfaceIDMapping().addAll((Collection<? extends InterfaceIDMapping_Containment_OrGroup>)newValue);
				return;
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseOperationID) {
				case QmmPackage.NAMED_ELEMENT___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.MAPPING___VALIDATE__DIAGNOSTICCHAIN_MAP;
