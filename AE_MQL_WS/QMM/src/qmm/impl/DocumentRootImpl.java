...
public class DocumentRootImpl extends RootClassImpl implements DocumentRoot {
	 ...
	 * @generated
	 */
	public EList<CAEXFile_Containment_OrGroup> getCAEXFile() {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case QmmPackage.DOCUMENT_ROOT__CAEX_FILE:
				getCAEXFile().clear();
				getCAEXFile().addAll((Collection<? extends CAEXFile_Containment_OrGroup>)newValue);
				return;
			case QmmPackage.DOCUMENT_ROOT__MIXED_ATTR_ECLASS:
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseOperationID) {
				case QmmPackage.NAMED_ELEMENT___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.DOCUMENT_ROOT___VALIDATE__DIAGNOSTICCHAIN_MAP;
