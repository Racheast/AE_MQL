...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>External Interface Reference Or Group</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link qmm.impl.ExternalInterface_Reference_OrGroupImpl#getReference <em>Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalInterface_Reference_OrGroupImpl extends Reference_OrGroupImpl implements ExternalInterface_Reference_OrGroup {
	/**
	 ...
	 * @ordered
	 */
	protected EList<ExternalInterface> reference;
	 ...
	 * @generated
	 */
	protected ExternalInterface_Reference_OrGroupImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return QmmPackage.eINSTANCE.getExternalInterface_Reference_OrGroup();
	}
	 ...
	 * @generated
	 */
	public EList<ExternalInterface> getReference() {
		if (reference == null) {
			reference = new EObjectResolvingEList<ExternalInterface>(ExternalInterface.class, this, QmmPackage.EXTERNAL_INTERFACE_REFERENCE_OR_GROUP__REFERENCE);
		}
		return reference;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QmmPackage.EXTERNAL_INTERFACE_REFERENCE_OR_GROUP__REFERENCE:
				return getReference();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QmmPackage.EXTERNAL_INTERFACE_REFERENCE_OR_GROUP__REFERENCE:
				getReference().clear();
				getReference().addAll((Collection<? extends ExternalInterface>)newValue);
				return;
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseOperationID) {
				case QmmPackage.NAMED_ELEMENT___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.EXTERNAL_INTERFACE_REFERENCE_OR_GROUP___VALIDATE__DIAGNOSTICCHAIN_MAP;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == OrGroup.class) {
			switch (baseOperationID) {
				case QmmPackage.OR_GROUP___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.EXTERNAL_INTERFACE_REFERENCE_OR_GROUP___VALIDATE__DIAGNOSTICCHAIN_MAP;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QmmPackage.EXTERNAL_INTERFACE_REFERENCE_OR_GROUP___VALIDATE__DIAGNOSTICCHAIN_MAP:
				return validate((DiagnosticChain)arguments.get(0), (Map)arguments.get(1));
		}
		return super.eInvoke(operationID, arguments);
	}

} //ExternalInterface_Reference_OrGroupImpl
