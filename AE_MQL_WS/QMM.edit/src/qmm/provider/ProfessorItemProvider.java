...
/**
 * This is the item provider adapter for a {@link qmm.Professor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProfessorItemProvider extends PersonItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmmPackage.eINSTANCE.getProfessor_Lectures());
			childrenFeatures.add(QmmPackage.eINSTANCE.getProfessor_EmployeeNumber_AttrEClass());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getProfessor_Lectures(),
				 QmmFactory.eINSTANCE.createCourse_Reference_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getProfessor_EmployeeNumber_AttrEClass(),
				 QmmFactory.eINSTANCE.createProfessor_employeeNumber_AttrEClass()));
	}
