...
/**
 * This is the item provider adapter for a {@link qmm.Student} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StudentItemProvider extends PersonItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmmPackage.eINSTANCE.getStudent_Attends());
			childrenFeatures.add(QmmPackage.eINSTANCE.getStudent_MatriculationNumber_AttrEClass());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getStudent_Attends(),
				 QmmFactory.eINSTANCE.createCourse_Reference_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getStudent_MatriculationNumber_AttrEClass(),
				 QmmFactory.eINSTANCE.createStudent_matriculationNumber_AttrEClass()));
	}
