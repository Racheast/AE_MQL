...
/**
 * This is the item provider adapter for a {@link qmm.startsWithOffset_FunctionalOperator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class startsWithOffset_FunctionalOperatorItemProvider extends String_Original_FunctionalOperatorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public startsWithOffset_FunctionalOperatorItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmmPackage.eINSTANCE.getstartsWithOffset_FunctionalOperator_Prefix());
			childrenFeatures.add(QmmPackage.eINSTANCE.getstartsWithOffset_FunctionalOperator_Toffset());
		}
	...
	/**
	 * This returns startsWithOffset_FunctionalOperator.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/startsWithOffset_FunctionalOperator"));
	}
	...
	public String getText(Object object) {
		startsWithOffset_FunctionalOperator startsWithOffset_FunctionalOperator = (startsWithOffset_FunctionalOperator)object;
		return getString("_UI_startsWithOffset_FunctionalOperator_type") + " " + startsWithOffset_FunctionalOperator.isNegated();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(startsWithOffset_FunctionalOperator.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getstartsWithOffset_FunctionalOperator_Prefix(),
				 QmmFactory.eINSTANCE.createString_FunctionalParameter()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getstartsWithOffset_FunctionalOperator_Toffset(),
