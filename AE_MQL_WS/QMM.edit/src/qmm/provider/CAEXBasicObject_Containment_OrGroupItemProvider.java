...
import qmm.CAEXBasicObject_Containment_OrGroup;
import qmm.QmmFactory;
import qmm.QmmPackage;

/**
 * This is the item provider adapter for a {@link qmm.CAEXBasicObject_Containment_OrGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CAEXBasicObject_Containment_OrGroupItemProvider extends Containment_OrGroupItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CAEXBasicObject_Containment_OrGroupItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmmPackage.eINSTANCE.getCAEXBasicObject_Containment_OrGroup_Containment());
		}
	...
	/**
	 * This returns CAEXBasicObject_Containment_OrGroup.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CAEXBasicObject_Containment_OrGroup"));
	}
	...
	public String getText(Object object) {
		String label = ((CAEXBasicObject_Containment_OrGroup)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CAEXBasicObject_Containment_OrGroup_type") :
			getString("_UI_CAEXBasicObject_Containment_OrGroup_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CAEXBasicObject_Containment_OrGroup.class)) {
			case QmmPackage.CAEX_BASIC_OBJECT_CONTAINMENT_OR_GROUP__CONTAINMENT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getCAEXBasicObject_Containment_OrGroup_Containment(),
