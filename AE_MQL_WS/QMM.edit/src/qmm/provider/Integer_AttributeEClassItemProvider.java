...
import qmm.Integer_AttributeEClass;
import qmm.QmmFactory;
import qmm.QmmPackage;

/**
 * This is the item provider adapter for a {@link qmm.Integer_AttributeEClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Integer_AttributeEClassItemProvider extends RegularAttributeEClassItemProvider {
	/**
	 ...
	 * @generated
	 */
	public Integer_AttributeEClassItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmmPackage.eINSTANCE.getInteger_AttributeEClass_Operator());
		}
	...
	public String getText(Object object) {
		String label = ((Integer_AttributeEClass)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Integer_AttributeEClass_type") :
			getString("_UI_Integer_AttributeEClass_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Integer_AttributeEClass.class)) {
			case QmmPackage.INTEGER_ATTRIBUTE_ECLASS__OPERATOR:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getInteger_AttributeEClass_Operator(),
