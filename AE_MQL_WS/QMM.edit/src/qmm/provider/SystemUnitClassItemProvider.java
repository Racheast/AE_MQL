		...
		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getSystemUnitClass_Attribute(),
				 QmmFactory.eINSTANCE.createAttribute_Containment_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getSystemUnitClass_ExternalInterface(),
				 QmmFactory.eINSTANCE.createInterfaceClass_Containment_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getSystemUnitClass_InternalElement(),
				 QmmFactory.eINSTANCE.createInternalElement_Containment_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getSystemUnitClass_SupportedRoleClass(),
				 QmmFactory.eINSTANCE.createSupportedRoleClass_Containment_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getSystemUnitClass_InternalLink(),
				 QmmFactory.eINSTANCE.createInternalLink_Containment_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getSystemUnitClass_BaseClass(),
				 QmmFactory.eINSTANCE.createSystemUnitClass_Reference_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getSystemUnitClass_SystemUnitClass(),
				 QmmFactory.eINSTANCE.createSystemUnitClass_Containment_OrGroup()));
