...
public class CAEXFileItemProvider extends CAEXBasicObjectItemProvider {
	...
	public String getText(Object object) {
		String label = ((CAEXFile)object).getName();
		...
		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getCAEXFile_SourceDocumentInformation(),
				 QmmFactory.eINSTANCE.createSourceDocumentInformation_Containment_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getCAEXFile_ExternalReference(),
				 QmmFactory.eINSTANCE.createExternalReferenceType_Containment_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getCAEXFile_InstanceHierarchy(),
				 QmmFactory.eINSTANCE.createInstanceHierarchy_Containment_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getCAEXFile_InterfaceClassLib(),
				 QmmFactory.eINSTANCE.createInterfaceClassLib_Containment_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getCAEXFile_RoleClassLib(),
				 QmmFactory.eINSTANCE.createRoleClassLib_Containment_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getCAEXFile_SystemUnitClassLib(),
				 QmmFactory.eINSTANCE.createSystemUnitClassLib_Containment_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getCAEXFile_AttributeTypeLib(),
				 QmmFactory.eINSTANCE.createAttributeLib_Containment_OrGroup()));
