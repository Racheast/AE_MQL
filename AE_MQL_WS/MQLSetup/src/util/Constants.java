...
public class Constants {
	...
	public final static String DMM_ECORE_FILE_PATH = WORKSPACE_PATH + "/../DMM/model/" + DMM_NAME + ".ecore";  
	...
	public final static String DMM_PACKAGE_NS_URI = "/DMM/model/" + DMM_NAME + ".ecore";
	...
	public final static URI QMM_GENMODEL_URI =  URI.createFileURI(WORKSPACE_PATH + "/../QMM/model/" + QMM_NAME + ".genmodel");
	...
	public final static URI QRMM_GENMODEL_URI =  URI.createFileURI(WORKSPACE_PATH + "/../QRMM/model/" + QRMM_NAME + ".genmodel");
	...
	/* org.MQLApplication.ui */
	public final static String ORG_XTEXT_MQL_UI_WORKSPACE_PATH = WORKSPACE_PATH + "/../MQLApplication/org.MQLApplication.ui";
