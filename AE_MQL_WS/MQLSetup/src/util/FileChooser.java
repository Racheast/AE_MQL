...
public class FileChooser extends Composite {
	...
	public void createContent() {
		...
		genQLButton.setText("Generate DMM.ecore, QMM.ecore, MQL.xtext");
		...
		genQLButton.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				String dmmPath = Constants.WORKSPACE_PATH + "/../DMM/model/DMM.ecore";
				...
				String xtextPath = Constants.WORKSPACE_PATH + "/../MQLApplication/org.MQLApplication/src/org/xtext/MQL.xtext";
				String atlPath = Constants.WORKSPACE_PATH + "/../org.xtext.MQL.ui/transformation";
				String constantsPath = Constants.WORKSPACE_PATH + "/../MQLApplication/org.MQLApplication.ui/src/org/xtext/ui/util/Constants.java";
				
				String infoMessage 	= "DMM.ecore has been generated into the project DMM (" + dmmPath + ").\nPlease run the \"Generate Model Code\"-task of DMM.genmodel to update the DMM metamodel."
									+	"\n\n"
									+	"QMM.ecore has been generated into the project QMM (" + qmmPath + ").\nPlease run the \"Generate All\"-task of QMM.genmodel to update the QMM metamodel."
									//+	"\n\n"
