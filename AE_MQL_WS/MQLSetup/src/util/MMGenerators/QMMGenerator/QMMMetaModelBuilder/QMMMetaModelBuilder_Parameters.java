...
public class QMMMetaModelBuilder_Parameters {
	...
	static ArrayList<EClass> createTypedParameter(String eType){
		...
		EObjectHelper.addValidationOperationToEClass(calculateableReferenceParameter,EObjectHelper.writeTypedParameterValidationBodyForEClass(paramName));
		...
		EObjectHelper.addValidationOperationToEClass(functionalParameter,EObjectHelper.writeTypedParameterValidationBodyForEClass(paramName));
