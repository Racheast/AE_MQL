...
public class QMMMetaModelBuilder_Collections {
	...
	public static HashMap<EClassifier, EClass> concreteContainmentOrGroups = new HashMap<EClassifier, EClass>();
	public static HashMap<EClassifier, EClass> concreteReferenceOrGroups = new HashMap<EClassifier, EClass>();
	public static HashMap<EClass,EClass> concreteReferences = new HashMap<EClass, EClass>();
