...
public class EObjectHelper {
	...
	public static void addValidationOperationToEClass(EClass ec, String body){
		...
		ec.getEOperations().add(eOperation);
	}
	...
	public static EClass createCalculatingOperator(String operatorName, String literal, String functionalType, String parameterType){
		...
		infoAnnotation.getDetails().put("operatorXTextLiteral", literal + "_" + functionalType);
	...
	public static EClass createClassOperator(String operatorName,String xTextLiteral, String literal, String functionalType, String parameterType){
		EAnnotation infoAnnotation = EObjectHelper.createEAnnotation("information");
		infoAnnotation.getDetails().put("functonalType", functionalType);
		infoAnnotation.getDetails().put("literal", literal);
		infoAnnotation.getDetails().put("operatorXTextLiteral", xTextLiteral);
	...
	public static String writeSuperclassValidationOperationCallIfExists(EClass ec){
		EList<EClass> eSuperTypes = ec.getEAllSuperTypes();
		for(EClass es : eSuperTypes)if(es != QMMMetaModelBuilder_Collections.defaultEClasses.get("RootClass")) return "super.validate(diagnostic, context);\n";
		return "";
	}
}
