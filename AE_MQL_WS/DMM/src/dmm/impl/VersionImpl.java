 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.VersionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link dmm.impl.VersionImpl#getChangeMode <em>Change Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VersionImpl extends MinimalEObjectImpl.Container implements Version {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.VERSION;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.VERSION__VALUE, oldValue, value));
	}
	...
	public void setChangeMode(ChangeMode newChangeMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.VERSION__CHANGE_MODE, oldChangeMode, changeMode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.VERSION__VALUE:
				return getValue();
			case DmmPackage.VERSION__CHANGE_MODE:
