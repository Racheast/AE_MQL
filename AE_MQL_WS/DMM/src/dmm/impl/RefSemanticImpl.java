 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.RefSemanticImpl#getCorrespondingAttributePath <em>Corresponding Attribute Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RefSemanticImpl extends CAEXBasicObjectImpl implements RefSemantic {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.REF_SEMANTIC;
	}
	...
	public void setCorrespondingAttributePath(String newCorrespondingAttributePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.REF_SEMANTIC__CORRESPONDING_ATTRIBUTE_PATH, oldCorrespondingAttributePath, correspondingAttributePath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.REF_SEMANTIC__CORRESPONDING_ATTRIBUTE_PATH:
