 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.ExternalInterfaceImpl#getExternalInterface <em>External Interface</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalInterfaceImpl extends InterfaceClassImpl implements ExternalInterface {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.EXTERNAL_INTERFACE;
	}
	...
	public EList<InterfaceClass> getExternalInterface() {
		if (externalInterface == null) {
			externalInterface = new EObjectContainmentEList<InterfaceClass>(InterfaceClass.class, this, DmmPackage.EXTERNAL_INTERFACE__EXTERNAL_INTERFACE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.EXTERNAL_INTERFACE__EXTERNAL_INTERFACE:
