 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.SystemUnitClassLibImpl#getSystemUnitClass <em>System Unit Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemUnitClassLibImpl extends CAEXObjectImpl implements SystemUnitClassLib {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.SYSTEM_UNIT_CLASS_LIB;
	}
	...
	public EList<SystemUnitClass> getSystemUnitClass() {
		if (systemUnitClass == null) {
			systemUnitClass = new EObjectContainmentEList<SystemUnitClass>(SystemUnitClass.class, this, DmmPackage.SYSTEM_UNIT_CLASS_LIB__SYSTEM_UNIT_CLASS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.SYSTEM_UNIT_CLASS_LIB__SYSTEM_UNIT_CLASS:
