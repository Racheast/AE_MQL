 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.InterfaceClassLibImpl#getInterfaceClass <em>Interface Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceClassLibImpl extends CAEXObjectImpl implements InterfaceClassLib {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.INTERFACE_CLASS_LIB;
	}
	...
	public EList<InterfaceClass> getInterfaceClass() {
		if (interfaceClass == null) {
			interfaceClass = new EObjectContainmentEList<InterfaceClass>(InterfaceClass.class, this, DmmPackage.INTERFACE_CLASS_LIB__INTERFACE_CLASS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.INTERFACE_CLASS_LIB__INTERFACE_CLASS:
