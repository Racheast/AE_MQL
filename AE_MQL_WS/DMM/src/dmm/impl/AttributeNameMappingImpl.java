...
import dmm.AttributeNameMapping;
 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.AttributeNameMappingImpl#getRoleAttributeName <em>Role Attribute Name</em>}</li>
 *   <li>{@link dmm.impl.AttributeNameMappingImpl#getSystemUnitAttributeName <em>System Unit Attribute Name</em>}</li>
 *   <li>{@link dmm.impl.AttributeNameMappingImpl#getRoleAttribute <em>Role Attribute</em>}</li>
 *   <li>{@link dmm.impl.AttributeNameMappingImpl#getSystemUnitAttribute <em>System Unit Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeNameMappingImpl extends CAEXBasicObjectImpl implements AttributeNameMapping {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.ATTRIBUTE_NAME_MAPPING;
	}
	...
	public void setRoleAttributeName(String newRoleAttributeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ATTRIBUTE_NAME_MAPPING__ROLE_ATTRIBUTE_NAME, oldRoleAttributeName, roleAttributeName));
	}
	...
	public void setSystemUnitAttributeName(String newSystemUnitAttributeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ATTRIBUTE_NAME_MAPPING__SYSTEM_UNIT_ATTRIBUTE_NAME, oldSystemUnitAttributeName, systemUnitAttributeName));
	}
	...
	public Attribute getRoleAttribute() {
		if (roleAttribute != null && roleAttribute.eIsProxy()) {
			...
			if (roleAttribute != oldRoleAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.ATTRIBUTE_NAME_MAPPING__ROLE_ATTRIBUTE, oldRoleAttribute, roleAttribute));
			}
		}
	...
	public void setRoleAttribute(Attribute newRoleAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ATTRIBUTE_NAME_MAPPING__ROLE_ATTRIBUTE, oldRoleAttribute, roleAttribute));
	}
	...
	public Attribute getSystemUnitAttribute() {
		if (systemUnitAttribute != null && systemUnitAttribute.eIsProxy()) {
			...
			if (systemUnitAttribute != oldSystemUnitAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.ATTRIBUTE_NAME_MAPPING__SYSTEM_UNIT_ATTRIBUTE, oldSystemUnitAttribute, systemUnitAttribute));
			}
		}
	...
	public void setSystemUnitAttribute(Attribute newSystemUnitAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ATTRIBUTE_NAME_MAPPING__SYSTEM_UNIT_ATTRIBUTE, oldSystemUnitAttribute, systemUnitAttribute));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.ATTRIBUTE_NAME_MAPPING__ROLE_ATTRIBUTE_NAME:
				return getRoleAttributeName();
			case DmmPackage.ATTRIBUTE_NAME_MAPPING__SYSTEM_UNIT_ATTRIBUTE_NAME:
				return getSystemUnitAttributeName();
			case DmmPackage.ATTRIBUTE_NAME_MAPPING__ROLE_ATTRIBUTE:
				if (resolve) return getRoleAttribute();
				return basicGetRoleAttribute();
			case DmmPackage.ATTRIBUTE_NAME_MAPPING__SYSTEM_UNIT_ATTRIBUTE:
