 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.SourceDocumentInformationImpl#getLastWritingDateTime <em>Last Writing Date Time</em>}</li>
 *   <li>{@link dmm.impl.SourceDocumentInformationImpl#getOriginID <em>Origin ID</em>}</li>
 *   <li>{@link dmm.impl.SourceDocumentInformationImpl#getOriginName <em>Origin Name</em>}</li>
 *   <li>{@link dmm.impl.SourceDocumentInformationImpl#getOriginProjectID <em>Origin Project ID</em>}</li>
 *   <li>{@link dmm.impl.SourceDocumentInformationImpl#getOriginProjectTitle <em>Origin Project Title</em>}</li>
 *   <li>{@link dmm.impl.SourceDocumentInformationImpl#getOriginRelease <em>Origin Release</em>}</li>
 *   <li>{@link dmm.impl.SourceDocumentInformationImpl#getOriginVendor <em>Origin Vendor</em>}</li>
 *   <li>{@link dmm.impl.SourceDocumentInformationImpl#getOriginVendorURL <em>Origin Vendor URL</em>}</li>
 *   <li>{@link dmm.impl.SourceDocumentInformationImpl#getOriginVersion <em>Origin Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SourceDocumentInformationImpl extends MinimalEObjectImpl.Container implements SourceDocumentInformation {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.SOURCE_DOCUMENT_INFORMATION;
	}
	...
	public void setLastWritingDateTime(XMLGregorianCalendar newLastWritingDateTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SOURCE_DOCUMENT_INFORMATION__LAST_WRITING_DATE_TIME, oldLastWritingDateTime, lastWritingDateTime));
	}
	...
	public void setOriginID(String newOriginID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_ID, oldOriginID, originID));
	}
	...
	public void setOriginName(String newOriginName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_NAME, oldOriginName, originName));
	}
	...
	public void setOriginProjectID(String newOriginProjectID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_PROJECT_ID, oldOriginProjectID, originProjectID));
	}
	...
	public void setOriginProjectTitle(String newOriginProjectTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_PROJECT_TITLE, oldOriginProjectTitle, originProjectTitle));
	}
	...
	public void setOriginRelease(String newOriginRelease) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_RELEASE, oldOriginRelease, originRelease));
	}
	...
	public void setOriginVendor(String newOriginVendor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_VENDOR, oldOriginVendor, originVendor));
	}
	...
	public void setOriginVendorURL(String newOriginVendorURL) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_VENDOR_URL, oldOriginVendorURL, originVendorURL));
	}
	...
	public void setOriginVersion(String newOriginVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_VERSION, oldOriginVersion, originVersion));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.SOURCE_DOCUMENT_INFORMATION__LAST_WRITING_DATE_TIME:
				return getLastWritingDateTime();
			case DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_ID:
				return getOriginID();
			case DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_NAME:
				return getOriginName();
			case DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_PROJECT_ID:
				return getOriginProjectID();
			case DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_PROJECT_TITLE:
				return getOriginProjectTitle();
			case DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_RELEASE:
				return getOriginRelease();
			case DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_VENDOR:
				return getOriginVendor();
			case DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_VENDOR_URL:
				return getOriginVendorURL();
			case DmmPackage.SOURCE_DOCUMENT_INFORMATION__ORIGIN_VERSION:
