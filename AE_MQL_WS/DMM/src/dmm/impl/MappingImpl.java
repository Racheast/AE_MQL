 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.MappingImpl#getAttributeNameMapping <em>Attribute Name Mapping</em>}</li>
 *   <li>{@link dmm.impl.MappingImpl#getInterfaceIDMapping <em>Interface ID Mapping</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MappingImpl extends CAEXBasicObjectImpl implements Mapping {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.MAPPING;
	}
	...
	public EList<AttributeNameMapping> getAttributeNameMapping() {
		if (attributeNameMapping == null) {
			attributeNameMapping = new EObjectContainmentEList<AttributeNameMapping>(AttributeNameMapping.class, this, DmmPackage.MAPPING__ATTRIBUTE_NAME_MAPPING);
		}
	...
	public EList<InterfaceIDMapping> getInterfaceIDMapping() {
		if (interfaceIDMapping == null) {
			interfaceIDMapping = new EObjectContainmentEList<InterfaceIDMapping>(InterfaceIDMapping.class, this, DmmPackage.MAPPING__INTERFACE_ID_MAPPING);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.MAPPING__ATTRIBUTE_NAME_MAPPING:
				return ((InternalEList<?>)getAttributeNameMapping()).basicRemove(otherEnd, msgs);
			case DmmPackage.MAPPING__INTERFACE_ID_MAPPING:
