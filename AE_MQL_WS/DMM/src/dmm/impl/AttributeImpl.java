 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.AttributeImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link dmm.impl.AttributeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link dmm.impl.AttributeImpl#getRefSemantic <em>Ref Semantic</em>}</li>
 *   <li>{@link dmm.impl.AttributeImpl#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link dmm.impl.AttributeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link dmm.impl.AttributeImpl#getAttributeDataType <em>Attribute Data Type</em>}</li>
 *   <li>{@link dmm.impl.AttributeImpl#getRefAttributeType <em>Ref Attribute Type</em>}</li>
 *   <li>{@link dmm.impl.AttributeImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeImpl extends CAEXObjectImpl implements Attribute {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.ATTRIBUTE;
	}
	...
	public void setDefaultValue(String newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ATTRIBUTE__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ATTRIBUTE__VALUE, oldValue, value));
	}
	...
	public EList<RefSemantic> getRefSemantic() {
		if (refSemantic == null) {
			refSemantic = new EObjectContainmentEList<RefSemantic>(RefSemantic.class, this, DmmPackage.ATTRIBUTE__REF_SEMANTIC);
		}
		return refSemantic;
	}
	...
	public EList<AttributeValueRequirement> getConstraint() {
		if (constraint == null) {
			constraint = new EObjectContainmentEList<AttributeValueRequirement>(AttributeValueRequirement.class, this, DmmPackage.ATTRIBUTE__CONSTRAINT);
		}
		return constraint;
	}
	...
	public EList<Attribute> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList<Attribute>(Attribute.class, this, DmmPackage.ATTRIBUTE__ATTRIBUTE);
		}
		return attribute;
	}
	...
	public void setAttributeDataType(String newAttributeDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ATTRIBUTE__ATTRIBUTE_DATA_TYPE, oldAttributeDataType, attributeDataType));
	}
	...
	public void setRefAttributeType(String newRefAttributeType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ATTRIBUTE__REF_ATTRIBUTE_TYPE, oldRefAttributeType, refAttributeType));
	}
	...
	public void setUnit(String newUnit) {
		...
		unit = newUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ATTRIBUTE__UNIT, oldUnit, unit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.ATTRIBUTE__REF_SEMANTIC:
				return ((InternalEList<?>)getRefSemantic()).basicRemove(otherEnd, msgs);
			case DmmPackage.ATTRIBUTE__CONSTRAINT:
				return ((InternalEList<?>)getConstraint()).basicRemove(otherEnd, msgs);
			case DmmPackage.ATTRIBUTE__ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.ATTRIBUTE__DEFAULT_VALUE:
				return getDefaultValue();
			case DmmPackage.ATTRIBUTE__VALUE:
				return getValue();
			case DmmPackage.ATTRIBUTE__REF_SEMANTIC:
			...
			case DmmPackage.ATTRIBUTE__ATTRIBUTE:
				return getAttribute();
			case DmmPackage.ATTRIBUTE__ATTRIBUTE_DATA_TYPE:
				return getAttributeDataType();
			case DmmPackage.ATTRIBUTE__REF_ATTRIBUTE_TYPE:
				return getRefAttributeType();
			case DmmPackage.ATTRIBUTE__UNIT:
				return getUnit();
		}
