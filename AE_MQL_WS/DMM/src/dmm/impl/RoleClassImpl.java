 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.RoleClassImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link dmm.impl.RoleClassImpl#getExternalInterface <em>External Interface</em>}</li>
 *   <li>{@link dmm.impl.RoleClassImpl#getRefBaseClassPath <em>Ref Base Class Path</em>}</li>
 *   <li>{@link dmm.impl.RoleClassImpl#getBaseClass <em>Base Class</em>}</li>
 *   <li>{@link dmm.impl.RoleClassImpl#getRoleClass <em>Role Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoleClassImpl extends CAEXObjectImpl implements RoleClass {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.ROLE_CLASS;
	}
	...
	public EList<Attribute> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList<Attribute>(Attribute.class, this, DmmPackage.ROLE_CLASS__ATTRIBUTE);
		}
		return attribute;
	}
	...
	public EList<ExternalInterface> getExternalInterface() {
		if (externalInterface == null) {
			externalInterface = new EObjectContainmentEList<ExternalInterface>(ExternalInterface.class, this, DmmPackage.ROLE_CLASS__EXTERNAL_INTERFACE);
		}
	...
	public void setRefBaseClassPath(String newRefBaseClassPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ROLE_CLASS__REF_BASE_CLASS_PATH, oldRefBaseClassPath, refBaseClassPath));
	}
	...
	public RoleClass getBaseClass() {
		if (baseClass != null && baseClass.eIsProxy()) {
			...
			if (baseClass != oldBaseClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.ROLE_CLASS__BASE_CLASS, oldBaseClass, baseClass));
			}
		}
		return baseClass;
	}
	...
	public void setBaseClass(RoleClass newBaseClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ROLE_CLASS__BASE_CLASS, oldBaseClass, baseClass));
	}
	...
	public EList<RoleClass> getRoleClass() {
		if (roleClass == null) {
			roleClass = new EObjectContainmentEList<RoleClass>(RoleClass.class, this, DmmPackage.ROLE_CLASS__ROLE_CLASS);
		}
		return roleClass;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.ROLE_CLASS__ATTRIBUTE:
				return ((InternalEList<?>)getAttribute()).basicRemove(otherEnd, msgs);
			case DmmPackage.ROLE_CLASS__EXTERNAL_INTERFACE:
				return ((InternalEList<?>)getExternalInterface()).basicRemove(otherEnd, msgs);
			case DmmPackage.ROLE_CLASS__ROLE_CLASS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DmmPackage.ROLE_CLASS__REF_BASE_CLASS_PATH:
				return getRefBaseClassPath();
			case DmmPackage.ROLE_CLASS__BASE_CLASS:
