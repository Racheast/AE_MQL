...
import dmm.Mapping;
import dmm.RoleClass;
import dmm.RoleRequirements;
 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.RoleRequirementsImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link dmm.impl.RoleRequirementsImpl#getExternalInterface <em>External Interface</em>}</li>
 *   <li>{@link dmm.impl.RoleRequirementsImpl#getMappingObject <em>Mapping Object</em>}</li>
 *   <li>{@link dmm.impl.RoleRequirementsImpl#getRoleClass <em>Role Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoleRequirementsImpl extends CAEXBasicObjectImpl implements RoleRequirements {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.ROLE_REQUIREMENTS;
	}
	...
	public EList<Attribute> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList<Attribute>(Attribute.class, this, DmmPackage.ROLE_REQUIREMENTS__ATTRIBUTE);
		}
		return attribute;
	}
	...
	public EList<InterfaceClass> getExternalInterface() {
		if (externalInterface == null) {
			externalInterface = new EObjectContainmentEList<InterfaceClass>(InterfaceClass.class, this, DmmPackage.ROLE_REQUIREMENTS__EXTERNAL_INTERFACE);
		}
	...
	public NotificationChain basicSetMappingObject(Mapping newMappingObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DmmPackage.ROLE_REQUIREMENTS__MAPPING_OBJECT, oldMappingObject, newMappingObject);
	...
	public void setMappingObject(Mapping newMappingObject) {
		if (newMappingObject != mappingObject) {
			...
			if (mappingObject != null)
				msgs = ((InternalEObject)mappingObject).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DmmPackage.ROLE_REQUIREMENTS__MAPPING_OBJECT, null, msgs);
			if (newMappingObject != null)
				msgs = ((InternalEObject)newMappingObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DmmPackage.ROLE_REQUIREMENTS__MAPPING_OBJECT, null, msgs);
			msgs = basicSetMappingObject(newMappingObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ROLE_REQUIREMENTS__MAPPING_OBJECT, newMappingObject, newMappingObject));
	}
	...
	public RoleClass getRoleClass() {
		if (roleClass != null && roleClass.eIsProxy()) {
			...
			if (roleClass != oldRoleClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.ROLE_REQUIREMENTS__ROLE_CLASS, oldRoleClass, roleClass));
			}
		}
		return roleClass;
	}
	...
	public void setRoleClass(RoleClass newRoleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.ROLE_REQUIREMENTS__ROLE_CLASS, oldRoleClass, roleClass));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.ROLE_REQUIREMENTS__ATTRIBUTE:
				return ((InternalEList<?>)getAttribute()).basicRemove(otherEnd, msgs);
			case DmmPackage.ROLE_REQUIREMENTS__EXTERNAL_INTERFACE:
				return ((InternalEList<?>)getExternalInterface()).basicRemove(otherEnd, msgs);
			case DmmPackage.ROLE_REQUIREMENTS__MAPPING_OBJECT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DmmPackage.ROLE_REQUIREMENTS__ROLE_CLASS:
