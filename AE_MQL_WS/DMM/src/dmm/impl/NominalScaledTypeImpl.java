 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.NominalScaledTypeImpl#getRequiredValue <em>Required Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NominalScaledTypeImpl extends MinimalEObjectImpl.Container implements NominalScaledType {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.NOMINAL_SCALED_TYPE;
	}
	...
	public EList<String> getRequiredValue() {
		if (requiredValue == null) {
			requiredValue = new EDataTypeEList<String>(String.class, this, DmmPackage.NOMINAL_SCALED_TYPE__REQUIRED_VALUE);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.NOMINAL_SCALED_TYPE__REQUIRED_VALUE:
