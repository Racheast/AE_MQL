...
import dmm.AttributeLib;
import dmm.CAEXFile;
import dmm.DmmPackage;
import dmm.ExternalReferenceType;
import dmm.InstanceHierarchy;
import dmm.InterfaceClassLib;
import dmm.RoleClassLib;
import dmm.SourceDocumentInformation;
import dmm.SystemUnitClassLib;
 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.CAEXFileImpl#getSuperiorStandardVersion <em>Superior Standard Version</em>}</li>
 *   <li>{@link dmm.impl.CAEXFileImpl#getSourceDocumentInformation <em>Source Document Information</em>}</li>
 *   <li>{@link dmm.impl.CAEXFileImpl#getExternalReference <em>External Reference</em>}</li>
 *   <li>{@link dmm.impl.CAEXFileImpl#getInstanceHierarchy <em>Instance Hierarchy</em>}</li>
 *   <li>{@link dmm.impl.CAEXFileImpl#getInterfaceClassLib <em>Interface Class Lib</em>}</li>
 *   <li>{@link dmm.impl.CAEXFileImpl#getRoleClassLib <em>Role Class Lib</em>}</li>
 *   <li>{@link dmm.impl.CAEXFileImpl#getSystemUnitClassLib <em>System Unit Class Lib</em>}</li>
 *   <li>{@link dmm.impl.CAEXFileImpl#getAttributeTypeLib <em>Attribute Type Lib</em>}</li>
 *   <li>{@link dmm.impl.CAEXFileImpl#getFileName <em>File Name</em>}</li>
 *   <li>{@link dmm.impl.CAEXFileImpl#getSchemaVersion <em>Schema Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CAEXFileImpl extends CAEXBasicObjectImpl implements CAEXFile {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.CAEX_FILE;
	}
	...
	public EList<String> getSuperiorStandardVersion() {
		if (superiorStandardVersion == null) {
			superiorStandardVersion = new EDataTypeEList<String>(String.class, this, DmmPackage.CAEX_FILE__SUPERIOR_STANDARD_VERSION);
		}
	...
	public EList<SourceDocumentInformation> getSourceDocumentInformation() {
		if (sourceDocumentInformation == null) {
			sourceDocumentInformation = new EObjectContainmentEList<SourceDocumentInformation>(SourceDocumentInformation.class, this, DmmPackage.CAEX_FILE__SOURCE_DOCUMENT_INFORMATION);
		}
	...
	public EList<ExternalReferenceType> getExternalReference() {
		if (externalReference == null) {
			externalReference = new EObjectContainmentEList<ExternalReferenceType>(ExternalReferenceType.class, this, DmmPackage.CAEX_FILE__EXTERNAL_REFERENCE);
		}
	...
	public EList<InstanceHierarchy> getInstanceHierarchy() {
		if (instanceHierarchy == null) {
			instanceHierarchy = new EObjectContainmentEList<InstanceHierarchy>(InstanceHierarchy.class, this, DmmPackage.CAEX_FILE__INSTANCE_HIERARCHY);
		}
	...
	public EList<InterfaceClassLib> getInterfaceClassLib() {
		if (interfaceClassLib == null) {
			interfaceClassLib = new EObjectContainmentEList<InterfaceClassLib>(InterfaceClassLib.class, this, DmmPackage.CAEX_FILE__INTERFACE_CLASS_LIB);
		}
	...
	public EList<RoleClassLib> getRoleClassLib() {
		if (roleClassLib == null) {
			roleClassLib = new EObjectContainmentEList<RoleClassLib>(RoleClassLib.class, this, DmmPackage.CAEX_FILE__ROLE_CLASS_LIB);
		}
		return roleClassLib;
	}
	...
	public EList<SystemUnitClassLib> getSystemUnitClassLib() {
		if (systemUnitClassLib == null) {
			systemUnitClassLib = new EObjectContainmentEList<SystemUnitClassLib>(SystemUnitClassLib.class, this, DmmPackage.CAEX_FILE__SYSTEM_UNIT_CLASS_LIB);
		}
	...
	public EList<AttributeLib> getAttributeTypeLib() {
		if (attributeTypeLib == null) {
			attributeTypeLib = new EObjectContainmentEList<AttributeLib>(AttributeLib.class, this, DmmPackage.CAEX_FILE__ATTRIBUTE_TYPE_LIB);
		}
	...
	public void setFileName(String newFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.CAEX_FILE__FILE_NAME, oldFileName, fileName));
	}
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.CAEX_FILE__SCHEMA_VERSION, oldSchemaVersion, schemaVersion, !oldSchemaVersionESet));
	}
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DmmPackage.CAEX_FILE__SCHEMA_VERSION, oldSchemaVersion, SCHEMA_VERSION_EDEFAULT, oldSchemaVersionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.CAEX_FILE__SUPERIOR_STANDARD_VERSION:
			...
			case DmmPackage.CAEX_FILE__FILE_NAME:
				return getFileName();
			case DmmPackage.CAEX_FILE__SCHEMA_VERSION:
