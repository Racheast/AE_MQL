...
import dmm.AdditionalInformation;
import dmm.CAEXBasicObject;
import dmm.ChangeMode;
import dmm.Copyright;
import dmm.Description;
 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.CAEXBasicObjectImpl#getChangeMode <em>Change Mode</em>}</li>
 *   <li>{@link dmm.impl.CAEXBasicObjectImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link dmm.impl.CAEXBasicObjectImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link dmm.impl.CAEXBasicObjectImpl#getRevision <em>Revision</em>}</li>
 *   <li>{@link dmm.impl.CAEXBasicObjectImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link dmm.impl.CAEXBasicObjectImpl#getAdditionalInformation <em>Additional Information</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CAEXBasicObjectImpl extends MinimalEObjectImpl.Container implements CAEXBasicObject {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.CAEX_BASIC_OBJECT;
	}
	...
	public void setChangeMode(ChangeMode newChangeMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.CAEX_BASIC_OBJECT__CHANGE_MODE, oldChangeMode, changeMode, !oldChangeModeESet));
	}
	...
	public void unsetChangeMode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DmmPackage.CAEX_BASIC_OBJECT__CHANGE_MODE, oldChangeMode, CHANGE_MODE_EDEFAULT, oldChangeModeESet));
	}
	...
	public Description getDescription() {
		if (description != null && description.eIsProxy()) {
			...
			if (description != oldDescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.CAEX_BASIC_OBJECT__DESCRIPTION, oldDescription, description));
			}
		}
		return description;
	}
	...
	public void setDescription(Description newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.CAEX_BASIC_OBJECT__DESCRIPTION, oldDescription, description));
	}
	...
	public Version getVersion() {
		if (version != null && version.eIsProxy()) {
			...
			if (version != oldVersion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.CAEX_BASIC_OBJECT__VERSION, oldVersion, version));
			}
		}
		return version;
	}
	...
	public void setVersion(Version newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.CAEX_BASIC_OBJECT__VERSION, oldVersion, version));
	}
	...
	public EList<Revision> getRevision() {
		if (revision == null) {
			revision = new EObjectResolvingEList<Revision>(Revision.class, this, DmmPackage.CAEX_BASIC_OBJECT__REVISION);
		}
		return revision;
	}
	...
	public Copyright getCopyright() {
		if (copyright != null && copyright.eIsProxy()) {
			...
			if (copyright != oldCopyright) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.CAEX_BASIC_OBJECT__COPYRIGHT, oldCopyright, copyright));
			}
		}
		return copyright;
	}
	...
	public void setCopyright(Copyright newCopyright) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.CAEX_BASIC_OBJECT__COPYRIGHT, oldCopyright, copyright));
	}
	...
	public AdditionalInformation getAdditionalInformation() {
		if (additionalInformation != null && additionalInformation.eIsProxy()) {
			...
			if (additionalInformation != oldAdditionalInformation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.CAEX_BASIC_OBJECT__ADDITIONAL_INFORMATION, oldAdditionalInformation, additionalInformation));
			}
		}
	...
	public void setAdditionalInformation(AdditionalInformation newAdditionalInformation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.CAEX_BASIC_OBJECT__ADDITIONAL_INFORMATION, oldAdditionalInformation, additionalInformation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.CAEX_BASIC_OBJECT__CHANGE_MODE:
				return getChangeMode();
			case DmmPackage.CAEX_BASIC_OBJECT__DESCRIPTION:
				if (resolve) return getDescription();
				return basicGetDescription();
			case DmmPackage.CAEX_BASIC_OBJECT__VERSION:
				if (resolve) return getVersion();
				return basicGetVersion();
			case DmmPackage.CAEX_BASIC_OBJECT__REVISION:
				return getRevision();
			case DmmPackage.CAEX_BASIC_OBJECT__COPYRIGHT:
				if (resolve) return getCopyright();
				return basicGetCopyright();
			case DmmPackage.CAEX_BASIC_OBJECT__ADDITIONAL_INFORMATION:
