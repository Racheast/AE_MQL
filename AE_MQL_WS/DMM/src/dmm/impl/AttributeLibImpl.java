 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.AttributeLibImpl#getAttributeType <em>Attribute Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeLibImpl extends CAEXObjectImpl implements AttributeLib {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.ATTRIBUTE_LIB;
	}
	...
	public EList<Attribute> getAttributeType() {
		if (attributeType == null) {
			attributeType = new EObjectContainmentEList<Attribute>(Attribute.class, this, DmmPackage.ATTRIBUTE_LIB__ATTRIBUTE_TYPE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.ATTRIBUTE_LIB__ATTRIBUTE_TYPE:
