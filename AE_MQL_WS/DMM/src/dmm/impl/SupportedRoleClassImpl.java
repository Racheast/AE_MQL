 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.SupportedRoleClassImpl#getMappingObject <em>Mapping Object</em>}</li>
 *   <li>{@link dmm.impl.SupportedRoleClassImpl#getRefRoleClassPath <em>Ref Role Class Path</em>}</li>
 *   <li>{@link dmm.impl.SupportedRoleClassImpl#getRoleClass <em>Role Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SupportedRoleClassImpl extends CAEXBasicObjectImpl implements SupportedRoleClass {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.SUPPORTED_ROLE_CLASS;
	}
	...
	public NotificationChain basicSetMappingObject(Mapping newMappingObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DmmPackage.SUPPORTED_ROLE_CLASS__MAPPING_OBJECT, oldMappingObject, newMappingObject);
	...
	public void setMappingObject(Mapping newMappingObject) {
		if (newMappingObject != mappingObject) {
			...
			if (mappingObject != null)
				msgs = ((InternalEObject)mappingObject).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DmmPackage.SUPPORTED_ROLE_CLASS__MAPPING_OBJECT, null, msgs);
			if (newMappingObject != null)
				msgs = ((InternalEObject)newMappingObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DmmPackage.SUPPORTED_ROLE_CLASS__MAPPING_OBJECT, null, msgs);
			msgs = basicSetMappingObject(newMappingObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SUPPORTED_ROLE_CLASS__MAPPING_OBJECT, newMappingObject, newMappingObject));
	}
	...
	public void setRefRoleClassPath(String newRefRoleClassPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SUPPORTED_ROLE_CLASS__REF_ROLE_CLASS_PATH, oldRefRoleClassPath, refRoleClassPath));
	}
	...
	public RoleClass getRoleClass() {
		if (roleClass != null && roleClass.eIsProxy()) {
			...
			if (roleClass != oldRoleClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.SUPPORTED_ROLE_CLASS__ROLE_CLASS, oldRoleClass, roleClass));
			}
		}
		return roleClass;
	}
	...
	public void setRoleClass(RoleClass newRoleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SUPPORTED_ROLE_CLASS__ROLE_CLASS, oldRoleClass, roleClass));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.SUPPORTED_ROLE_CLASS__MAPPING_OBJECT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DmmPackage.SUPPORTED_ROLE_CLASS__REF_ROLE_CLASS_PATH:
				return getRefRoleClassPath();
			case DmmPackage.SUPPORTED_ROLE_CLASS__ROLE_CLASS:
