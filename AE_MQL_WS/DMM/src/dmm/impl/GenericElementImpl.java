 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.GenericElementImpl#getNestedElements <em>Nested Elements</em>}</li>
 *   <li>{@link dmm.impl.GenericElementImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link dmm.impl.GenericElementImpl#getElementFeatureMap <em>Element Feature Map</em>}</li>
 *   <li>{@link dmm.impl.GenericElementImpl#getAttributeFeatureMap <em>Attribute Feature Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenericElementImpl extends ElementImpl implements GenericElement {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.GENERIC_ELEMENT;
	}
	...
	public EList<GenericElement> getNestedElements() {
		if (nestedElements == null) {
			nestedElements = new EObjectContainmentEList<GenericElement>(GenericElement.class, this, DmmPackage.GENERIC_ELEMENT__NESTED_ELEMENTS);
		}
	...
	public EList<GenericAttribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<GenericAttribute>(GenericAttribute.class, this, DmmPackage.GENERIC_ELEMENT__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public FeatureMap getElementFeatureMap() {
		if (elementFeatureMap == null) {
			elementFeatureMap = new BasicFeatureMap(this, DmmPackage.GENERIC_ELEMENT__ELEMENT_FEATURE_MAP);
		}
	...
	public FeatureMap getAttributeFeatureMap() {
		if (attributeFeatureMap == null) {
			attributeFeatureMap = new BasicFeatureMap(this, DmmPackage.GENERIC_ELEMENT__ATTRIBUTE_FEATURE_MAP);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.GENERIC_ELEMENT__NESTED_ELEMENTS:
				return ((InternalEList<?>)getNestedElements()).basicRemove(otherEnd, msgs);
			case DmmPackage.GENERIC_ELEMENT__ATTRIBUTES:
				return ((InternalEList<?>)getAttributes()).basicRemove(otherEnd, msgs);
			case DmmPackage.GENERIC_ELEMENT__ELEMENT_FEATURE_MAP:
				return ((InternalEList<?>)getElementFeatureMap()).basicRemove(otherEnd, msgs);
			case DmmPackage.GENERIC_ELEMENT__ATTRIBUTE_FEATURE_MAP:
