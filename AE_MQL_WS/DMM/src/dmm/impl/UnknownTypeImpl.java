 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.UnknownTypeImpl#getRequirements <em>Requirements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnknownTypeImpl extends MinimalEObjectImpl.Container implements UnknownType {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.UNKNOWN_TYPE;
	}
	...
	public void setRequirements(String newRequirements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.UNKNOWN_TYPE__REQUIREMENTS, oldRequirements, requirements));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.UNKNOWN_TYPE__REQUIREMENTS:
