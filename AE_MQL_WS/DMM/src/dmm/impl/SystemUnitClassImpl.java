...
import dmm.Attribute;
import dmm.DmmPackage;
import dmm.InterfaceClass;
import dmm.InternalElement;
import dmm.InternalLink;
import dmm.SupportedRoleClass;
import dmm.SystemUnitClass;
 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.SystemUnitClassImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link dmm.impl.SystemUnitClassImpl#getExternalInterface <em>External Interface</em>}</li>
 *   <li>{@link dmm.impl.SystemUnitClassImpl#getInternalElement <em>Internal Element</em>}</li>
 *   <li>{@link dmm.impl.SystemUnitClassImpl#getSupportedRoleClass <em>Supported Role Class</em>}</li>
 *   <li>{@link dmm.impl.SystemUnitClassImpl#getInternalLink <em>Internal Link</em>}</li>
 *   <li>{@link dmm.impl.SystemUnitClassImpl#getBaseClass <em>Base Class</em>}</li>
 *   <li>{@link dmm.impl.SystemUnitClassImpl#getSystemUnitClass <em>System Unit Class</em>}</li>
 *   <li>{@link dmm.impl.SystemUnitClassImpl#getRefBaseClassPath <em>Ref Base Class Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemUnitClassImpl extends CAEXObjectImpl implements SystemUnitClass {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.SYSTEM_UNIT_CLASS;
	}
	...
	public EList<Attribute> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList<Attribute>(Attribute.class, this, DmmPackage.SYSTEM_UNIT_CLASS__ATTRIBUTE);
		}
		return attribute;
	}
	...
	public EList<InterfaceClass> getExternalInterface() {
		if (externalInterface == null) {
			externalInterface = new EObjectContainmentEList<InterfaceClass>(InterfaceClass.class, this, DmmPackage.SYSTEM_UNIT_CLASS__EXTERNAL_INTERFACE);
		}
	...
	public EList<InternalElement> getInternalElement() {
		if (internalElement == null) {
			internalElement = new EObjectContainmentEList<InternalElement>(InternalElement.class, this, DmmPackage.SYSTEM_UNIT_CLASS__INTERNAL_ELEMENT);
		}
	...
	public EList<SupportedRoleClass> getSupportedRoleClass() {
		if (supportedRoleClass == null) {
			supportedRoleClass = new EObjectContainmentEList<SupportedRoleClass>(SupportedRoleClass.class, this, DmmPackage.SYSTEM_UNIT_CLASS__SUPPORTED_ROLE_CLASS);
		}
	...
	public EList<InternalLink> getInternalLink() {
		if (internalLink == null) {
			internalLink = new EObjectContainmentEList<InternalLink>(InternalLink.class, this, DmmPackage.SYSTEM_UNIT_CLASS__INTERNAL_LINK);
		}
		return internalLink;
	}
		...
		if (baseClass != null && baseClass.eIsProxy()) {
			...
			if (baseClass != oldBaseClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.SYSTEM_UNIT_CLASS__BASE_CLASS, oldBaseClass, baseClass));
			}
		}
		return baseClass;
	}
	...
	public void setBaseClass(SystemUnitClass newBaseClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SYSTEM_UNIT_CLASS__BASE_CLASS, oldBaseClass, baseClass));
	}
	...
	public EList<SystemUnitClass> getSystemUnitClass() {
		if (systemUnitClass == null) {
			systemUnitClass = new EObjectContainmentEList<SystemUnitClass>(SystemUnitClass.class, this, DmmPackage.SYSTEM_UNIT_CLASS__SYSTEM_UNIT_CLASS);
		}
	...
	public void setRefBaseClassPath(String newRefBaseClassPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.SYSTEM_UNIT_CLASS__REF_BASE_CLASS_PATH, oldRefBaseClassPath, refBaseClassPath));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.SYSTEM_UNIT_CLASS__ATTRIBUTE:
				return ((InternalEList<?>)getAttribute()).basicRemove(otherEnd, msgs);
			case DmmPackage.SYSTEM_UNIT_CLASS__EXTERNAL_INTERFACE:
				return ((InternalEList<?>)getExternalInterface()).basicRemove(otherEnd, msgs);
			case DmmPackage.SYSTEM_UNIT_CLASS__INTERNAL_ELEMENT:
				return ((InternalEList<?>)getInternalElement()).basicRemove(otherEnd, msgs);
			case DmmPackage.SYSTEM_UNIT_CLASS__SUPPORTED_ROLE_CLASS:
				return ((InternalEList<?>)getSupportedRoleClass()).basicRemove(otherEnd, msgs);
			case DmmPackage.SYSTEM_UNIT_CLASS__INTERNAL_LINK:
				return ((InternalEList<?>)getInternalLink()).basicRemove(otherEnd, msgs);
			case DmmPackage.SYSTEM_UNIT_CLASS__SYSTEM_UNIT_CLASS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DmmPackage.SYSTEM_UNIT_CLASS__BASE_CLASS:
				if (resolve) return getBaseClass();
				return basicGetBaseClass();
			case DmmPackage.SYSTEM_UNIT_CLASS__SYSTEM_UNIT_CLASS:
				return getSystemUnitClass();
			case DmmPackage.SYSTEM_UNIT_CLASS__REF_BASE_CLASS_PATH:
