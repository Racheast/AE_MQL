 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.InternalLinkImpl#getRefPartnerSideA <em>Ref Partner Side A</em>}</li>
 *   <li>{@link dmm.impl.InternalLinkImpl#getRefPartnerSideB <em>Ref Partner Side B</em>}</li>
 *   <li>{@link dmm.impl.InternalLinkImpl#getPartnerSideA <em>Partner Side A</em>}</li>
 *   <li>{@link dmm.impl.InternalLinkImpl#getPartnerSideB <em>Partner Side B</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternalLinkImpl extends CAEXObjectImpl implements InternalLink {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.INTERNAL_LINK;
	}
	...
	public void setRefPartnerSideA(String newRefPartnerSideA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.INTERNAL_LINK__REF_PARTNER_SIDE_A, oldRefPartnerSideA, refPartnerSideA));
	}
	...
	public void setRefPartnerSideB(String newRefPartnerSideB) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.INTERNAL_LINK__REF_PARTNER_SIDE_B, oldRefPartnerSideB, refPartnerSideB));
	}
	...
	public ExternalInterface getPartnerSideA() {
		if (partnerSideA != null && partnerSideA.eIsProxy()) {
			...
			if (partnerSideA != oldPartnerSideA) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.INTERNAL_LINK__PARTNER_SIDE_A, oldPartnerSideA, partnerSideA));
			}
		}
		return partnerSideA;
	}
	...
	public void setPartnerSideA(ExternalInterface newPartnerSideA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.INTERNAL_LINK__PARTNER_SIDE_A, oldPartnerSideA, partnerSideA));
	}
	...
	public ExternalInterface getPartnerSideB() {
		if (partnerSideB != null && partnerSideB.eIsProxy()) {
			...
			if (partnerSideB != oldPartnerSideB) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.INTERNAL_LINK__PARTNER_SIDE_B, oldPartnerSideB, partnerSideB));
			}
		}
		return partnerSideB;
	}
	...
	public void setPartnerSideB(ExternalInterface newPartnerSideB) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.INTERNAL_LINK__PARTNER_SIDE_B, oldPartnerSideB, partnerSideB));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.INTERNAL_LINK__REF_PARTNER_SIDE_A:
				return getRefPartnerSideA();
			case DmmPackage.INTERNAL_LINK__REF_PARTNER_SIDE_B:
				return getRefPartnerSideB();
			case DmmPackage.INTERNAL_LINK__PARTNER_SIDE_A:
				if (resolve) return getPartnerSideA();
				return basicGetPartnerSideA();
			case DmmPackage.INTERNAL_LINK__PARTNER_SIDE_B:
