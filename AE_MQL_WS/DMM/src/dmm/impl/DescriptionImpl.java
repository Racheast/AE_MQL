 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.DescriptionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link dmm.impl.DescriptionImpl#getChangeMode <em>Change Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DescriptionImpl extends MinimalEObjectImpl.Container implements Description {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.DESCRIPTION;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.DESCRIPTION__VALUE, oldValue, value));
	}
	...
	public void setChangeMode(ChangeMode newChangeMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.DESCRIPTION__CHANGE_MODE, oldChangeMode, changeMode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.DESCRIPTION__VALUE:
				return getValue();
			case DmmPackage.DESCRIPTION__CHANGE_MODE:
