 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.InternalElementImpl#getRoleRequirements <em>Role Requirements</em>}</li>
 *   <li>{@link dmm.impl.InternalElementImpl#getRefBaseSystemUnitPath <em>Ref Base System Unit Path</em>}</li>
 *   <li>{@link dmm.impl.InternalElementImpl#getBaseSystemUnit <em>Base System Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternalElementImpl extends SystemUnitClassImpl implements InternalElement {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.INTERNAL_ELEMENT;
	}
	...
	public EList<RoleRequirements> getRoleRequirements() {
		if (roleRequirements == null) {
			roleRequirements = new EObjectContainmentEList<RoleRequirements>(RoleRequirements.class, this, DmmPackage.INTERNAL_ELEMENT__ROLE_REQUIREMENTS);
		}
	...
	public void setRefBaseSystemUnitPath(String newRefBaseSystemUnitPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.INTERNAL_ELEMENT__REF_BASE_SYSTEM_UNIT_PATH, oldRefBaseSystemUnitPath, refBaseSystemUnitPath));
	}
	...
	public SystemUnitClass getBaseSystemUnit() {
		if (baseSystemUnit != null && baseSystemUnit.eIsProxy()) {
			...
			if (baseSystemUnit != oldBaseSystemUnit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.INTERNAL_ELEMENT__BASE_SYSTEM_UNIT, oldBaseSystemUnit, baseSystemUnit));
			}
		}
	...
	public void setBaseSystemUnit(SystemUnitClass newBaseSystemUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.INTERNAL_ELEMENT__BASE_SYSTEM_UNIT, oldBaseSystemUnit, baseSystemUnit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.INTERNAL_ELEMENT__ROLE_REQUIREMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DmmPackage.INTERNAL_ELEMENT__REF_BASE_SYSTEM_UNIT_PATH:
				return getRefBaseSystemUnitPath();
			case DmmPackage.INTERNAL_ELEMENT__BASE_SYSTEM_UNIT:
