 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.InstanceHierarchyImpl#getInternalElement <em>Internal Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstanceHierarchyImpl extends CAEXObjectImpl implements InstanceHierarchy {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.INSTANCE_HIERARCHY;
	}
	...
	public EList<InternalElement> getInternalElement() {
		if (internalElement == null) {
			internalElement = new EObjectContainmentEList<InternalElement>(InternalElement.class, this, DmmPackage.INSTANCE_HIERARCHY__INTERNAL_ELEMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.INSTANCE_HIERARCHY__INTERNAL_ELEMENT:
