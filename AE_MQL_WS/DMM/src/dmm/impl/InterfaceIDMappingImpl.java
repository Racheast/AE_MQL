...
import dmm.ExternalInterface;
import dmm.InterfaceIDMapping;
 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.InterfaceIDMappingImpl#getRoleInterfaceID <em>Role Interface ID</em>}</li>
 *   <li>{@link dmm.impl.InterfaceIDMappingImpl#getSystemUnitInterfaceID <em>System Unit Interface ID</em>}</li>
 *   <li>{@link dmm.impl.InterfaceIDMappingImpl#getRoleInterface <em>Role Interface</em>}</li>
 *   <li>{@link dmm.impl.InterfaceIDMappingImpl#getSystemUnitInterface <em>System Unit Interface</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceIDMappingImpl extends CAEXBasicObjectImpl implements InterfaceIDMapping {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.INTERFACE_ID_MAPPING;
	}
	...
	public void setRoleInterfaceID(String newRoleInterfaceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.INTERFACE_ID_MAPPING__ROLE_INTERFACE_ID, oldRoleInterfaceID, roleInterfaceID));
	}
	...
	public void setSystemUnitInterfaceID(String newSystemUnitInterfaceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.INTERFACE_ID_MAPPING__SYSTEM_UNIT_INTERFACE_ID, oldSystemUnitInterfaceID, systemUnitInterfaceID));
	}
	...
	public ExternalInterface getRoleInterface() {
		if (roleInterface != null && roleInterface.eIsProxy()) {
			...
			if (roleInterface != oldRoleInterface) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.INTERFACE_ID_MAPPING__ROLE_INTERFACE, oldRoleInterface, roleInterface));
			}
		}
	...
	public void setRoleInterface(ExternalInterface newRoleInterface) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.INTERFACE_ID_MAPPING__ROLE_INTERFACE, oldRoleInterface, roleInterface));
	}
	...
	public ExternalInterface getSystemUnitInterface() {
		if (systemUnitInterface != null && systemUnitInterface.eIsProxy()) {
			...
			if (systemUnitInterface != oldSystemUnitInterface) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.INTERFACE_ID_MAPPING__SYSTEM_UNIT_INTERFACE, oldSystemUnitInterface, systemUnitInterface));
			}
		}
	...
	public void setSystemUnitInterface(ExternalInterface newSystemUnitInterface) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.INTERFACE_ID_MAPPING__SYSTEM_UNIT_INTERFACE, oldSystemUnitInterface, systemUnitInterface));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.INTERFACE_ID_MAPPING__ROLE_INTERFACE_ID:
				return getRoleInterfaceID();
			case DmmPackage.INTERFACE_ID_MAPPING__SYSTEM_UNIT_INTERFACE_ID:
				return getSystemUnitInterfaceID();
			case DmmPackage.INTERFACE_ID_MAPPING__ROLE_INTERFACE:
				if (resolve) return getRoleInterface();
				return basicGetRoleInterface();
			case DmmPackage.INTERFACE_ID_MAPPING__SYSTEM_UNIT_INTERFACE:
