 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.InterfaceClassImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link dmm.impl.InterfaceClassImpl#getRefBaseClassPath <em>Ref Base Class Path</em>}</li>
 *   <li>{@link dmm.impl.InterfaceClassImpl#getBaseClass <em>Base Class</em>}</li>
 *   <li>{@link dmm.impl.InterfaceClassImpl#getInterfaceClass <em>Interface Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceClassImpl extends CAEXObjectImpl implements InterfaceClass {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.INTERFACE_CLASS;
	}
	...
	public EList<Attribute> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList<Attribute>(Attribute.class, this, DmmPackage.INTERFACE_CLASS__ATTRIBUTE);
		}
		return attribute;
	}
	...
	public void setRefBaseClassPath(String newRefBaseClassPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.INTERFACE_CLASS__REF_BASE_CLASS_PATH, oldRefBaseClassPath, refBaseClassPath));
	}
	...
	public InterfaceClass getBaseClass() {
		if (baseClass != null && baseClass.eIsProxy()) {
			...
			if (baseClass != oldBaseClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DmmPackage.INTERFACE_CLASS__BASE_CLASS, oldBaseClass, baseClass));
			}
		}
		return baseClass;
	}
	...
	public void setBaseClass(InterfaceClass newBaseClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.INTERFACE_CLASS__BASE_CLASS, oldBaseClass, baseClass));
	}
	...
	public EList<InterfaceClass> getInterfaceClass() {
		if (interfaceClass == null) {
			interfaceClass = new EObjectContainmentEList<InterfaceClass>(InterfaceClass.class, this, DmmPackage.INTERFACE_CLASS__INTERFACE_CLASS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.INTERFACE_CLASS__ATTRIBUTE:
				return ((InternalEList<?>)getAttribute()).basicRemove(otherEnd, msgs);
			case DmmPackage.INTERFACE_CLASS__INTERFACE_CLASS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.INTERFACE_CLASS__ATTRIBUTE:
				return getAttribute();
			case DmmPackage.INTERFACE_CLASS__REF_BASE_CLASS_PATH:
				return getRefBaseClassPath();
			case DmmPackage.INTERFACE_CLASS__BASE_CLASS:
