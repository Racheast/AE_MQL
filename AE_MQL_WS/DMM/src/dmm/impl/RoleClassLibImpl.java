 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.RoleClassLibImpl#getRoleClass <em>Role Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoleClassLibImpl extends CAEXObjectImpl implements RoleClassLib {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.ROLE_CLASS_LIB;
	}
	...
	public EList<RoleClass> getRoleClass() {
		if (roleClass == null) {
			roleClass = new EObjectContainmentEList<RoleClass>(RoleClass.class, this, DmmPackage.ROLE_CLASS_LIB__ROLE_CLASS);
		}
		return roleClass;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DmmPackage.ROLE_CLASS_LIB__ROLE_CLASS:
