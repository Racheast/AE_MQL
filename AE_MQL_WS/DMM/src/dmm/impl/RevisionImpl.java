 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.impl.RevisionImpl#getRevisionDate <em>Revision Date</em>}</li>
 *   <li>{@link dmm.impl.RevisionImpl#getOldVersion <em>Old Version</em>}</li>
 *   <li>{@link dmm.impl.RevisionImpl#getNewVersion <em>New Version</em>}</li>
 *   <li>{@link dmm.impl.RevisionImpl#getAuthorName <em>Author Name</em>}</li>
 *   <li>{@link dmm.impl.RevisionImpl#getComment <em>Comment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RevisionImpl extends CAEXBasicObjectImpl implements Revision {
	...
	protected EClass eStaticClass() {
		return DmmPackage.Literals.REVISION;
	}
	...
	public void setRevisionDate(XMLGregorianCalendar newRevisionDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.REVISION__REVISION_DATE, oldRevisionDate, revisionDate));
	}
	...
	public void setOldVersion(String newOldVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.REVISION__OLD_VERSION, oldOldVersion, oldVersion));
	}
	...
	public void setNewVersion(String newNewVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.REVISION__NEW_VERSION, oldNewVersion, newVersion));
	}
	...
	public void setAuthorName(String newAuthorName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.REVISION__AUTHOR_NAME, oldAuthorName, authorName));
	}
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmmPackage.REVISION__COMMENT, oldComment, comment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmmPackage.REVISION__REVISION_DATE:
				return getRevisionDate();
			case DmmPackage.REVISION__OLD_VERSION:
				return getOldVersion();
			case DmmPackage.REVISION__NEW_VERSION:
				return getNewVersion();
			case DmmPackage.REVISION__AUTHOR_NAME:
				return getAuthorName();
			case DmmPackage.REVISION__COMMENT:
				return getComment();
		}
