 ...
 * </p>
 * <ul>
 *   <li>{@link dmm.RefSemantic#getCorrespondingAttributePath <em>Corresponding Attribute Path</em>}</li>
 * </ul>
 *
 * @see dmm.DmmPackage#getRefSemantic()
 * @model
 * @generated
 */
public interface RefSemantic extends CAEXBasicObject {
	 ...
	 * @see dmm.DmmPackage#getRefSemantic_CorrespondingAttributePath()
	...
	/**
	 * Sets the value of the '{@link dmm.RefSemantic#getCorrespondingAttributePath <em>Corresponding Attribute Path</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
