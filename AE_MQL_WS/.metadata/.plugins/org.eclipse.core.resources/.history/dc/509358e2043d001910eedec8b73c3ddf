...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Min Aggregation Operator Double</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link qmm.Min_AggregationOperator_Double#getCalculateable <em>Calculateable</em>}</li>
 * </ul>
 *
 * @see qmm.QmmPackage#getMin_AggregationOperator_Double()
 * @model annotation="information functionalType='Double' literal='min' operatorXTextLiteral='min_Double'"
 * @generated
 */
public interface Min_AggregationOperator_Double extends CalculatingAggregationOperator, Double_EvaluationOperation_Argument {
	/**
	 ...
	 * @see qmm.QmmPackage#getMin_AggregationOperator_Double_Calculateable()
	...
	/**
	 * Sets the value of the '{@link qmm.Min_AggregationOperator_Double#getCalculateable <em>Calculateable</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
