 ...
 * </p>
 * <ul>
 *   <li>{@link qmm.impl.OrGroupImpl#isGeneralized <em>Generalized</em>}</li>
...
public abstract class OrGroupImpl extends NamedElementImpl implements OrGroup {
	...
	public void setGeneralized(boolean newGeneralized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QmmPackage.OR_GROUP__GENERALIZED, oldGeneralized, generalized));
	}
	...
	public boolean validate(final DiagnosticChain diagnostic, final Map context) {
		EClass containerEClass = this.eContainingFeature().getEContainingClass();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QmmPackage.OR_GROUP__GENERALIZED:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == GeneralizableElement.class) {
			switch (derivedFeatureID) {
				case QmmPackage.OR_GROUP__GENERALIZED: return QmmPackage.GENERALIZABLE_ELEMENT__GENERALIZED;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == GeneralizableElement.class) {
			switch (baseFeatureID) {
				case QmmPackage.GENERALIZABLE_ELEMENT__GENERALIZED: return QmmPackage.OR_GROUP__GENERALIZED;
				default: return -1;
			}
		}
		if (baseClass == NegatableElement.class) {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseOperationID) {
				case QmmPackage.NAMED_ELEMENT___VALIDATE__DIAGNOSTICCHAIN_MAP: return QmmPackage.OR_GROUP___VALIDATE__DIAGNOSTICCHAIN_MAP;
