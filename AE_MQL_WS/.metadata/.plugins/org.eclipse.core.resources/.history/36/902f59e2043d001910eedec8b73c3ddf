...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Number Integer Object Number hash Code Functional Operator</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see qmm.QmmPackage#getNumber_Integer_Object_Number_hashCode_FunctionalOperator()
 ...
 * @generated
 */
public interface Number_Integer_Object_Number_hashCode_FunctionalOperator extends InheritedFrom_Number_to_Integer_FunctionalOperator, Integer_FunctionalType {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
