...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Min Aggregation Operator Integer</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link qmm.Min_AggregationOperator_Integer#getCalculateable <em>Calculateable</em>}</li>
 * </ul>
 *
 * @see qmm.QmmPackage#getMin_AggregationOperator_Integer()
 * @model annotation="information functionalType='Integer' literal='min' operatorXTextLiteral='min_Integer'"
 * @generated
 */
public interface Min_AggregationOperator_Integer extends CalculatingAggregationOperator, Integer_EvaluationOperation_Argument {
	/**
	 ...
	 * @see qmm.QmmPackage#getMin_AggregationOperator_Integer_Calculateable()
	...
	/**
	 * Sets the value of the '{@link qmm.Min_AggregationOperator_Integer#getCalculateable <em>Calculateable</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
