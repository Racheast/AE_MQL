...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Person Reference Or Group</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link qmm.Person_Reference_OrGroup#getReference <em>Reference</em>}</li>
 * </ul>
 *
 * @see qmm.QmmPackage#getPerson_Reference_OrGroup()
 * @model
 * @generated
 */
public interface Person_Reference_OrGroup extends Reference_OrGroup {
	/**
	 ...
	 * @see qmm.QmmPackage#getPerson_Reference_OrGroup_Reference()
	 * @model
	 * @generated
	 */
	EList<Person> getReference();
