...
public class Constants{
		/* WORKSPACE CONSTANT */
		public final static String WORKSPACE_PATH = (ResourcesPlugin.getWorkspace().getRoot().getLocation().toFile().toString()).replace("\\", "/") + "/../../org.MQLApplication.ui";

		/* DMM CONSTANTS */
		public final static String DMM_NsPrefix="University";
		public final static String DMM_NAME = "DMM";
		public final static String DMM_NsURI = "/DMM/model/" + DMM_NAME + ".ecore";
